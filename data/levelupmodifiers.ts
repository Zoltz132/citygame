module CityGame
{
  export module LevelUpModifiers
  {
    ...
    export var fundingBoost1: IPlayerModifier =
    {
      type: "fundingBoost1",
    ...
    export var clicksPerParking1: IPlayerModifier =
    {
    ...
    export var clicksPerLevel1: IPlayerModifier =
    {
    ...
    export var shoppingCostReduction1: IPlayerModifier =
    {
    ...
    export var parkingCostReduction1: IPlayerModifier =
    {
    ...
    export var fundingBoost2: IPlayerModifier =
    {
      type: "fundingBoost2",
    ...
    export var america1: IPlayerModifier =
    {
      type: "america1",
    ...
    export var betterSellPrice1: IPlayerModifier =
    {
    ...
    export var increasedRecruitQuality1: IPlayerModifier =
    {
    ...
    export var fundingBoost3: IPlayerModifier =
    {
      type: "fundingBoost3",
    ...
    export var buildRush1: IPlayerModifier =
    {
      type: "buildRush1",
    ...
    export var buildCostReduction1: IPlayerModifier =
    {
    ...
    export var buyRush1: IPlayerModifier =
    {
      type: "buyRush1",
      title: "Land grab",
    ...
    export var clickFrenzy1: IPlayerModifier =
    {
      type: "clickFrenzy1",
      title: "Click frenzy",
    ...
    export var shoppingProfitPerApartment: IPlayerModifier =
    {
    ...
    export var branchOffices1: IPlayerModifier =
    {
      type: "branchOffices1",
    ...
    export var increasedRecruitQuality2: IPlayerModifier =
    {
    ...
    export var prestigeEffectIncrease1: IPlayerModifier =
    {
    ...
    export var shoppingCostReductionPerFactory: IPlayerModifier =
    {
    ...
    export var hotelParking1: IPlayerModifier =
    {
      type: "hotelParking1",
      title: "Valet service",
    ...
    export var hotelFastfood1: IPlayerModifier =
    {
      type: "hotelFastfood1",
    ...
    export var factoryPerLevel1: IPlayerModifier =
    {
    ...
    export var prestigeHotel1: IPlayerModifier =
    {
      type: "prestigeHotel1",
    ...
    export var branchOffices2: IPlayerModifier =
    {
      type: "branchOffices2",
